...
class HomeScreen extends StatefulWidget {
  const HomeScreen({super.key, required this.title, required this.onLocaleChange});
...
class _HomeScreenState extends State<HomeScreen> {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          content: Text(l10n.failedToLoad, style: const TextStyle(color: AppColors.textPrimary)),
        ),
      );
    } finally {
  ...
  Future<void> _sendItem() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          backgroundColor: AppColors.surface,
          content: Text(l10n.failedToSend, style: const TextStyle(color: AppColors.textPrimary)),
        ),
      );
    } finally {
  ...
  Future<void> _handleReset() async {
    ...
    navigator.pushAndRemoveUntil(
      MaterialPageRoute(
        builder: (context) => SetupScreen(onLocaleChange: widget.onLocaleChange),
      ),
      (route) => false,
    );
  }
        ...
        title: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.content_paste_rounded, color: Colors.black, size: 18),
            ),
              ...
              children: [
                ...
                Text(
                  _isLoading
                      ? l10n.syncing
                      : (_lastSynced != null
                          ? l10n.lastSynced(formatTimestamp(context, _lastSynced!))
                          : l10n.notSyncedYet),
              ...
              child: _isLoading && _items.isEmpty
                  ...
                  : _items.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) => InboxCard(item: _items[index]),
                        ),
            ),
          ),
          MessageInput(
